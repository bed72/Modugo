...
///
/// [ModugoContainer] manages dependency registration, resolution, and disposal.
...
/// ### Example
/// ```dart
/// final container = ModugoContainer();
///
...
final class ModugoContainer {
  ...
  void disposeAll() {
    ...
    final globalTypes =
        _binds.keys.where((type) => !allTypes.contains(type)).toList();
